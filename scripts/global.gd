...
const LEVEL_FILE : String = "res://scenes/levels/level_"
const TUTORIAL_FILE : String = "res://scenes/tutorials/tutorial_"
...
var unlocked_tutorials : Array = [0]
var tutorial_has_been_done : bool = true
